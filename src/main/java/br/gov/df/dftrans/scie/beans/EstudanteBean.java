...
public class EstudanteBean {
	...
	public String pesquisar() {
		...
		AutenticacaoBean meuBean = (AutenticacaoBean) resolver.getValue(context.getELContext(), null, "loginBean");
		...
		if (SelectCPFDAO.getSegundaVia(codCPFsemMascara)) {
			...
			if(SelectCPFDAO.getAutenticacaoSITPASS(codCPFsemMascara, getSenha())){
				...
				FacesUtil.addMsggError("A senha não confere com o CPF " + codCPF
						+ "! Verifique se o CPF e a Senha digitados estão corretos!");
				return "/pages/estudanteHome.xhtml?faces-redirect=false";
			}
		} else {
			FacesUtil.addMsggError("O CPF " + codCPF
					+ " não está cadastrado ou já possui solicitação pendente! Verifique se o CPF digitado está correto!");
			return "/pages/estudanteHome.xhtml?faces-redirect=false";
		}
	}
	...
	public String pesquisarAgendamentos() {
		...
		if (!(SelectCPFDAO.contains(codCPFsemMascara))) {
			FacesUtil.addMsggError("O CPF " + codCPF + " não está cadastrado, ou ainda não foi processado!");
			return "/pages/estudanteAgendamento.xhtml?faces-redirect=false";
		} else {
			HttpSession session = (HttpSession) FacesContext.getCurrentInstance().getExternalContext()
					.getSession(false);
			session.setAttribute("estudante", codCPFsemMascara);
			if(SelectCPFDAO.getAutenticacaoSITPASS(codCPFsemMascara, getSenha())){
				return "/pages/estudante/consultarAgendamento.xhtml?faces-redirect=true";
			}else{
				FacesUtil.addMsggError("A senha não confere com o CPF " + codCPF
						+ "! Verifique se o CPF e a Senha digitados estão corretos!");
				return "/pages/estudanteAgendamento.xhtml?faces-redirect=false";
	...
	public String textoAgendamentos() {
		...
		for (int i = 0; i < getAgendamentos().length; i++) {
			if (getAgendamentos()[i][2] != null) {
				retorno += "<hr><h2>Prezado(a) " + getAgendamentos()[i][0] + ",<br/></h2>"
						+ "<font color=\"red\"><b>Parab&eacute;ns, seu Passe Livre Estudantil est&aacute; liberado!</b></font><br/><br/>"
						+ "Seu cart&atilde;o ser&aacute; entregue no <font color=\"red\"><b>"+ getAgendamentos()[i][5] +"</b></font>.<br/><br/>"
						+ "Mas aten&ccedil;&atilde;o: Para <font color=\"red\"><b>maiores de 18 anos</b></font>, a entrega s&oacute; ser&aacute; realizada mediante a presen&ccedil;a do estudante, portando documento de <font color=\"red\"><b>identidade e CPF</b></font>. Ningu&eacute;m poder&aacute; "
						+ "retirar por voc&ecirc;.<br/>"
						+ "Para estudantes <font color=\"red\"><b>menores de 18 anos</b></font>, o pai, a m&atilde;e ou o respons&aacute;vel legal poder&aacute; receber o cart&atilde;o, mediante a apresenta&ccedil;&atilde;o do documento de <font color=\"red\"><b>identidade e CPF pr&oacute;prios e do estudante.</b></font><br/><br/>"
						+ "<div align=\"center\">A entrega do seu cart&atilde;o est&aacute; agendada para:<br/>"
						+ "<font color=\"red\"><b>Dia " + getAgendamentos()[i][2].substring(6, 8) + "/"
						+ getAgendamentos()[i][2].substring(4, 6) + "/" + getAgendamentos()[i][2].substring(0, 4)
						+ " no per&iacute;odo entre " + getAgendamentos()[i][3] + " (" + getAgendamentos()[i][4]
						+ ").</b></font></div><br/>"
						+ "Fique atento para a data de entrega do ser cart&atilde;o Passe Livre Estudantil.<br/><br/>"
						+ "<font color=\"red\"><b>N&atilde;o perca esta data!!!</b></font><br/><br/>"
						...
						+ "e depois escolha a op&ccedil;&atilde;o 1.</font><br/><br/><hr/>";
			}
		}
		setAgendamentos(SelectCPFDAO.getCargaEmbarcada(codCPFsemMascara, nome));
		for (int i = 0; i < getAgendamentos().length; i++) {
			s = getAgendamentos()[i][1];
			nroCartao = s.substring(0, 1) + "." + s.substring(1, 4) + "." + s.substring(4, 7) + "."
					+ s.substring(7, 10);
			s = getAgendamentos()[i][2];
			nroCPF = s.substring(0, 3) + "." + s.substring(3, 6) + "." + s.substring(6, 9) + "-" + s.substring(9, 11);
			retorno += "<hr><h2>Prezado(a) " + getAgendamentos()[i][0] + ",<br/></h2>"
					+ "<font color=\"red\"><b>Parab&eacute;ns, seu Passe Livre Estudantil j&aacute; est&aacute; liberado!</b></font><br/><br/>"
					+ "Informamos que seu cart&atilde;o de n&uacute;mero " + nroCartao
					+ " est&aacute; atualizado e desbloqueado para uso!<br/>"
					+ "<font color=\"red\"><b>ATEN&Ccedil;&Atilde;O!!! No primeiro acesso voc&ecirc; receber&aacute; a mensagem: \"CARTAO REGRAVADO COM AS CONFIGURACOES DO MES ATUAL\". Ser&aacute; necess&aacute;rio passar novamente o cart&atilde;o para liberar a catraca (apenas no primeiro acesso).</b></font><br/>"
					+ "Seguem suas informa&ccedil;&otilde;es para confer&ecirc;ncia:<br/><br/>"
					+ "<div align=\"center\">" + "Nome: <font color=\"red\"><b>" + getAgendamentos()[i][0]
					+ "</b></font><br/>" + "CPF: <font color=\"red\"><b>" + nroCPF + "</b></font><br/>"
					+ "N&uacute;mero do cart&atilde;o: <font color=\"red\"><b>" + nroCartao + "</b></font><br/>"
					+ "</div><br/><br/>"
					...
					+ "<font size=\"1\">Atenciosamente,<br/>" + "Transporte Urbano do Distrito Federal - DFTRANS<br/>"
					+ "N&atilde;o responda a esta mensagem. Para maiores esclarecimentos, acesse o site <a href=\"http://www.passelivreestudantil.df.gov.br\">www.passelivreestudantil.df.gov.br</a> ou ligue 156, escolha a op&ccedil;&atilde;o 4 "
					+ "e depois escolha a op&ccedil;&atilde;o 1.</font><hr/>";
		}
		if (retorno.isEmpty()) {
			retorno = "<hr><h2>Prezado(a) " + getNome() + ",<br/></h2>"
					+ "Lamentamos mas seu Passe Livre Estudantil ainda n&atilde;o est&aacute; agendado para entrega. Estamos providenciando este agendamento no prazo mais breve poss&iacute;vel!<br/><br/>"
					+ "<font size=\"1\">Atenciosamente,<br/>" + "Transporte Urbano do Distrito Federal - DFTRANS<br/>"
					+ "N&atilde;o responda a esta mensagem. Para maiores esclarecimentos, acesse o site <a href=\"http://www.passelivreestudantil.df.gov.br\">www.passelivreestudantil.df.gov.br</a> ou ligue 156, escolha a op&ccedil;&atilde;o 4 "
					+ "e depois escolha a op&ccedil;&atilde;o 1.</font><br/><br/><hr/>";
		}
